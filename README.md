## class_loader (noetic) - 0.5.2-1

The packages in the `class_loader` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic class_loader` on `Fri, 25 Apr 2025 23:28:56 -0000`
...
The packages in the `class_loader` repository were released into the `indigo` distro by running `/usr/bin/bloom-release class_loader -t indigo -r indigo` on `Tue, 20 Sep 2016 22:21:40 -0000`
